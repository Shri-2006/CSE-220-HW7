...
Test(base_execute, mult_mats0stu2) { run_script_without_valgrind("script04"); }
Test(base_execute_valgrind, mult_mats0stu2) { expect_no_valgrind_errors(run_script_with_valgrind("script04")); }

Test(base_execute, trans_matstu01) { run_script_without_valgrind("script05"); }
Test(base_execute_valgrind, trans_matstu01) { expect_no_valgrind_errors(run_script_with_valgrind("script05")); }

Test(base_execute, trans_mat02stu) { run_script_without_valgrind("script06"); }
Test(base_execute_valgrind, trans_mat02stu) { expect_no_valgrind_errors(run_script_with_valgrind("script06")); }

Test(base_execute, add_mats0stu3) { run_script_without_valgrind("script07"); } // A + B + C
Test(base_execute_valgrind, add_mats03stu) { expect_no_valgrind_errors(run_script_with_valgrind("script07")); }

Test(base_execute, mult_mats03_stustu) { run_script_without_valgrind("script08"); } // A * B * C
Test(base_execute_valgrind, mult_mats03stu) { expect_no_valgrind_errors(run_script_with_valgrind("script08")); }

Test(base_execute, trans_mat03stu) { run_script_without_valgrind("script09"); } // A''
Test(base_execute_valgrind, trans_mat03stu) { expect_no_valgrind_errors(run_script_with_valgrind("script09")); }

Test(base_execute, script10stu) { run_script_without_valgrind("script10"); } // A * B + C
Test(base_execute_valgrind, script10stu) { expect_no_valgrind_errors(run_script_with_valgrind("script10")); }

Test(base_execute, script11stu) { run_script_without_valgrind("script11"); } // A + B * C
Test(base_execute_valgrind, script1stu1) { expect_no_valgrind_errors(run_script_with_valgrind("script11")); }

Test(base_execute, script1stu2) { run_script_without_valgrind("script12"); } // (A + B) * C
Test(base_execute_valgrind, script12stu) { expect_no_valgrind_errors(run_script_with_valgrind("script12")); }

Test(base_execute, scriptstu13) { run_script_without_valgrind("script13"); } // (A + B) * (C + D)
Test(base_execute_valgrind, scripstut13) { expect_no_valgrind_errors(run_script_with_valgrind("script13")); }

Test(base_execute, scriptstu14) { run_script_without_valgrind("script14"); } // (A + B * C) * (C + D * E) * (E + F * G)
Test(base_execute_valgrind, scriptstu14) { expect_no_valgrind_errors(run_script_with_valgrind("script14")); }

Test(base_execute, scripstut15) { run_script_without_valgrind("script15"); } // (A + B * C) * (C + D * E)
Test(base_execute_valgrind, scriptstu15) { expect_no_valgrind_errors(run_script_with_valgrind("script15")); }

Test(base_execute, scriptstu16) { run_script_without_valgrind("script16"); } // A' * B + C
Test(base_execute_valgrind, scriptstu16) { expect_no_valgrind_errors(run_script_with_valgrind("script16")); }

Test(base_execute, script1stu7) { run_script_without_valgrind("script17"); } // (A' * B + C)'
Test(base_execute_valgrind, script1stu7) { expect_no_valgrind_errors(run_script_with_valgrind("script17")); }

Test(base_execute, scriptstu18) { run_script_without_valgrind("script18"); } 
Test(base_execute_valgrind, scriptstu18) { expect_no_valgrind_errors(run_script_with_valgrind("script18")); }

Test(base_execute, scriptstu19) { run_script_without_valgrind("script19"); } 
Test(base_execute_valgrind, scripstut19) { expect_no_valgrind_errors(run_script_with_valgrind("script19")); }

Test(base_execute, scriptstu20) { run_script_without_valgrind("script20"); } 
Test(base_execute_valgrind, script2stu0) { expect_no_valgrind_errors(run_script_with_valgrind("script20")); }
